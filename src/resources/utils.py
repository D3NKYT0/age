...
def check_authorization(db, user, authorization_list, super_user=False):
    classifier_id = user.User.classified_as if not super_user else user.SuperUser.classified_as
