...
@router.post('/token', response_model=schemas_usuarios.LoginSucesso, status_code=status.HTTP_200_OK)
...
@router.get('/me', status_code=status.HTTP_200_OK, response_model=schemas_usuarios.UsuarioSimples)
