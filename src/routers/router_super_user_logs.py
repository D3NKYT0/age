...
from src.schemas import schemas_super_users_logs
...
@router.get('/get/{id}', status_code=status.HTTP_200_OK, response_model=schemas_super_users_logs.SimpleSuperUserLogs, tags=["super_users_logs"])
...
@router.get('/get/all', status_code=status.HTTP_200_OK, response_model=List[schemas_super_users_logs.SimpleSuperUserLogs], tags=["super_users_logs"])
...
@router.post('/register/', status_code=status.HTTP_201_CREATED, response_model=schemas_super_users_logs.SimpleSuperUserLogs, tags=["super_users_logs"])
def create_Logs_super_user(logs_super_user: schemas_super_users_logs.SuperUserLogs, _ = Depends(get_user_logged), db: Session = Depends(get_db)):
...
@router.put('/update/{id}', status_code=status.HTTP_200_OK, response_model=schemas_super_users_logs.SimpleSuperUserLogs, tags=["super_users_logs"])
def update_super_users_logs(id: int, super_user_logs: schemas_super_users_logs.SuperUser, _ = Depends(get_user_logged), db: Session = Depends(get_db)):
...
@router.delete('/delete/{id}', status_code=status.HTTP_200_OK, response_model=schemas_super_users_logs.SimpleSuperUserLogs, tags=["super_users_logs"])
