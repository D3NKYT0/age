...
@router.get('/get/{id}', status_code=status.HTTP_200_OK, response_model=schemas_lse.SimpleLse, dependencies=[Depends(RateLimiter(times=2, seconds=5))], tags=["lse"])
...
@router.get('/get/all/', status_code=status.HTTP_200_OK, response_model=List[schemas_lse.SimpleLse], dependencies=[Depends(RateLimiter(times=2, seconds=5))], tags=["lse"])
...
@router.post('/register/', status_code=status.HTTP_201_CREATED, response_model=schemas_lse.SimpleLse, dependencies=[Depends(RateLimiter(times=2, seconds=5))], tags=["lse"])
...
@router.put('/update/{id}', status_code=status.HTTP_200_OK, response_model=schemas_lse.SimpleLse, dependencies=[Depends(RateLimiter(times=2, seconds=5))], tags=["lse"])
...
@router.delete('/delete/{id}', status_code=status.HTTP_200_OK, response_model=schemas_lse.SimpleLse, dependencies=[Depends(RateLimiter(times=2, seconds=5))], tags=["lse"])
